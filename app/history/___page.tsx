      ...
      {rows.length === 0 ? (
        ...
        <>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", marginTop: 24 }}>
            <colgroup>
              <col style={{ width: "10%" }} /> {/* お題 */}
              <col style={{ width: "10%" }} /> {/* 笑顔スコア */}
              <col style={{ width: "30%" }} /> {/* フィードバック */}
              <col style={{ width: "10%" }} /> {/* 日付 */}
              <col style={{ width: "25%" }} /> {/* メモ */}
              <col style={{ width: "15%" }} />  {/* 削除 */}
            </colgroup>
            <thead>
              <tr>
                <th style={{ textAlign: "left", borderBottom: "1px solid #ccc", padding: 8 }}>お題</th>
                <th style={{ textAlign: "left", borderBottom: "1px solid #ccc", padding: 8 }}>笑顔スコア</th>
